...
export class App implements OnInit {
  ...
  private async login(startParams: string | null): Promise<void> {
    ...
    const initData =
      'query_id=AAH3bMUqAgAAAPdsxSpHnY7H&user=%7B%22id%22%3A5012548855%2C%22first_name%22%3A%22%D0%90%D1%81%D1%80%D0%BE%D1%80%22%2C%22last_name%22%3A%22%D0%A8%D0%BE%D0%B4%D0%B8%D0%B5%D0%B2%22%2C%22username%22%3A%22W_339A%22%2C%22language_code%22%3A%22ru%22%2C%22allows_write_to_pm%22%3Atrue%2C%22photo_url%22%3A%22https%3A%5C%2F%5C%2Ft.me%5C%2Fi%5C%2Fuserpic%5C%2F320%5C%2FKQiqYjmBpV_7fr_BWZ8V8IFv6es-Y3spZ0Y-Y9P8XtkD7Dv_-fbJpr9C-f_hSvn-.svg%22%7D&auth_date=1769598743&signature=7-yHIHZrCsrL1jGDLON5b-XclYjGcKEk3MpAQDixMgx9ZROKnZWZdhV0wwqX0BjCJMq5cAMuj2DbON-o7L26Cw&hash=bc02af670ff8f123a8b59cd45d8a79fd9dc694f8627e4cdda47b845d9ec351b3';
    if (!initData) return;

    await firstValueFrom(
      this.accountService.login({ initData: initData, invite_token: startParams }),
    ).then((res) => {
      if (startParams) {
        this.getPlan(startParams);
      }
